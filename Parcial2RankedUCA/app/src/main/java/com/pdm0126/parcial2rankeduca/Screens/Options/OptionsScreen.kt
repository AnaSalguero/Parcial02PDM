package com.pdm0126.parcial2rankeduca.Screens.Options
...
@Composable
//Con la llave se crea un nuevo viewModel cuando reconoce que el id cambia y reutiliza los anteriores cuando sus ids son iguales
fun OptionsScreen(
    questionId: Int,
    navBack:()->Unit,
